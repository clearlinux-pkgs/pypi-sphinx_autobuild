...
Source0  : https://files.pythonhosted.org/packages/06/31/47bbd8d10b673aa5abba794c4424e58b245d1c5b0d016081913555c24357/sphinx_autobuild-2024.2.4.tar.gz
...
%prep
%setup -q -n sphinx_autobuild-2024.2.4
cd %{_builddir}/sphinx_autobuild-2024.2.4
pushd ..
cp -a sphinx_autobuild-2024.2.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707236113
