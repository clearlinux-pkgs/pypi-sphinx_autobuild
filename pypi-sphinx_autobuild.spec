...
Source0  : https://files.pythonhosted.org/packages/5d/99/9d1712eb73a08a39d86f0f4c177ea1298af3d9aa2d6a0619accc03f1e5ec/sphinx_autobuild-2024.9.3.tar.gz
...
%prep
%setup -q -n sphinx_autobuild-2024.9.3
cd %{_builddir}/sphinx_autobuild-2024.9.3
pushd ..
cp -a sphinx_autobuild-2024.9.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725373200
