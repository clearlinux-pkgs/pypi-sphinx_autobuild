...
%prep
%setup -q -n sphinx_autobuild-2024.10.3
cd %{_builddir}/sphinx_autobuild-2024.10.3
pushd ..
cp -a sphinx_autobuild-2024.10.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727967783
